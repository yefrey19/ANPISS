...
<body>
    ...
    <main class="contenedor">
        <div class="p-3 rounded">
            <div class="row">
                <div class="col">
                    <h4>𝐄𝐝𝐢𝐭𝐚𝐫 Limpieza</h4>
                </div>
            </div>

            <div class="row">
                <div class="col">
                    <form class="row g-3" method="POST" action="guardarLim.php" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <label for="stock" class="form-label">Puertas</label>
                            <input type="text" id="stock" name="puertas" value="<?php echo $row['puertas']; ?>" class="form-control" require>
                        </div>

                        <div class="col-md-4">
                            <label for="stock" class="form-label">Mesas</label>
                            <input type="text" id="stock" name="mesas" value="<?php echo $row['mesas']; ?>" class="form-control" require>
                        </div>

                        <div class="col-md-4">
                            <label for="stock" class="form-label">Sillas</label>
                            <input type="text" id="stock" name="sillas" value="<?php echo $row['sillas']; ?>" class="form-control" require>
                        </div>
